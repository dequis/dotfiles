...
let g:colors_name = "wombat256roger"
...
call <SID>X("Normal",		"",	"trans",	"none")
call <SID>X("Cursor",		"222222",	"ecee90",	"none")
call <SID>X("CursorLine", "", "212121", "none")
call <SID>X("PdbCurrentLine", "", "2d2d2d", "none")

call <SID>X("CursorColumn",	"",			"2d2d2d",	"")
			"CursorIM
			"Question
			"IncSearch
call <SID>X("Search",		"444444",	"dfbf00",	"")
call <SID>X("MatchParen",	"ecee90",	"857b6f",	"bold")
call <SID>X("SpecialKey",	"8c8c8c",	"",	"none")
call <SID>X("Visual",		"",	"6f4c10",	"none")
call <SID>X("LineNr",		"857b6f",	"121212",	"none")
call <SID>X("Folded",		"fff",	"trans",	"none")
...
call <SID>X("PyFlakes",	"ffffff",	"ff0000",			"")
			"ErrorMsg
			"ModeMsg
			"MoreMsg
			"Directory
...
call <SID>X("Special",		"cfae3d",	"",			"none")
call <SID>X("Todo",			"ffffff",	"cc2211",			"italic")
			"Underlined
			"Error
			"Ignore
